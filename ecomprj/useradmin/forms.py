...
class AddProductForm(forms.ModelForm):
    ...
    description = forms.CharField(widget=forms.TextInput(attrs={"placeholder": "Product Description", "class": "form-control"}))
    price = forms.CharField(widget=forms.TextInput(attrs={"placeholder": "Sale Price", "class": "form-control"}))
    old_price = forms.CharField(widget=forms.TextInput(attrs={"placeholder": "Old Price", "class": "form-control"}))
    ...
    mfd = forms.CharField(widget=forms.TextInput(attrs={"placeholder": "e.g. 22-11-2024", "class": "form-control"}))
